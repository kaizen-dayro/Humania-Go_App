    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          {esSuperAdmin && (
            <Link href="/admin/presupuesto" onClick={cerrar} className="flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-white/10 transition-colors text-sm font-medium">
              <Calculator className="w-5 h-5 text-humania-sand" />
